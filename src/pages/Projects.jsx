      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="group bg-white dark:bg-black border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-500 hover:border-black dark:hover:border-white cursor-pointer"
            ...
            >
              ...
              {/* CONTENU */}
              <div className="p-6">
                <h3 className="text-lg font-bold mb-3 text-black dark:text-white line-clamp-2 leading-tight">
                  {project.title}
                </h3>
                ...
                <div className="text-xs font-medium tracking-wider uppercase text-black dark:text-white group-hover:opacity-60 transition-opacity">
